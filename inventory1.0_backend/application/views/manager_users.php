...
<div class=" row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> manager users</h2>
	...
	<form class="navbar-search pull-left" style="margin-left:200px;" action="<?php echo base_url('index.php/admin/users'); ?>" method="get">
         ...
         <a class="btn btn-primary btn-round btn-lg" style="float:right; margin-right:200px; margin-top:10px;" href="<?php echo base_url('index.php/admin/insert_user');?>">add new user </a>
    ...
    <tr>
        ...
        <td class="center"><?php echo $item->user_level; ?></td>
        <td class="center">
			<a class="btn btn-info" href="<?php echo base_url('index.php/admin/change_password/'.$item->user_id); ?>">
                <i class="glyphicon glyphicon-edit icon-white"></i>
                Change Password
            </a>
            <a class="btn btn-danger" href="<?php echo base_url('index.php/admin/delete_user/'.$item->user_id); ?>" onclick="return confirm('Are you sure want to delete?')">
