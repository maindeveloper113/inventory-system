            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="<?php echo base_url('index.php/user'); ?>"><i class="glyphicon glyphicon-eye-open"></i><span> manager inventory</span></a>
                        </li>
...
<div class=" row">
	...
	<form class="navbar-search pull-left" style="margin-left:400px;" action="<?php echo base_url('index.php/user/invantories'); ?>" method="get">
    ...
    <tr>
		...
		<td class="center">
			<a class="btn btn-info" href="<?php echo base_url('index.php/user/edit_inventory/'.$item->inventory_id); ?>">
                <i class="glyphicon glyphicon-edit icon-white"></i>
                Edit
            </a>
            <a class="btn btn-danger" href="<?php echo base_url('index.php/user/confirm_remove_inventory/'.$item->inventory_id); ?>" >
