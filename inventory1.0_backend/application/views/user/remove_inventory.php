...
<div class=" row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class=" glyphicon glyphicon-pencil"></i> remove inventory</h2>
		<!--
        <div class="box-icon">
    ...
    <div class="box-content">
		...
		<form name="add_user" action="<?php echo base_url('index.php/user/remove_inventory/'.$inventory->inventory_id); ?>" method="post">
		<div class="control-group">
						<label class="control-label" for="selectError">Select Quantity</label>

						<div class="controls">
							<select name="remove_quantity" id="selectError" data-rel="chosen">
                    ...
                    <button type="submit" class="btn btn-default" style="margin-top:10px" onclick="return confirm('Are you sure want remove? ')">Submit</button>
		</form>
					...
					<div class="form-group">
                        ...
                        <input name="description" type="text" class="form-control" id="description" list="descriptionname"  value="<?php echo $inventory->description; ?>" readonly>
							
					</div>

					<div class="form-group">
                        <label for="exampleInputEmail1">Location</label>
                        <input name="location" type="text" class="form-control" id="location" list="locationname"  value="<?php echo $inventory->location; ?>" readonly>
					...
					<div class="form-group">
                        ...
                        <input name="remark" type="text" class="form-control" id="remark" list="remarkname"  value="<?php echo $inventory->remark; ?>" readonly>
