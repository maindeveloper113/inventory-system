...
<div class=" row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> change user password</h2>
		<!--
        <div class="box-icon">
    ...
    <div class="box-content">
		...
		<form name="add_user" action="<?php echo base_url('index.php/admin/register_pass/'.$user_id); ?>" method="post">
