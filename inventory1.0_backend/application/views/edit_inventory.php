...
<div class=" row">
    ...
    <div class="box-content">
		...
		<form name="add_user" action="<?php echo base_url('index.php/admin/update_inventory/'.$inventory->inventory_id); ?>" method="post">
					
                    <div class="form-group">
                        <label for="exampleInputPassword1">Serial number</label>
                        <input name="serial_number"  class="form-control" id="serial_number" placeholder="Enter serial number" value="<?php echo $inventory->serial_number; ?>">
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
                        ...
                        <input name="quantity" type="text" class="form-control" id="quantity" value="<?php echo $inventory->quantity; ?>" readonly>
						
					</div>
					<div class="form-group">
                        <label for="exampleInputEmail1">Remark</label>
                        <input name="remark" type="text" class="form-control" id="remark" value="<?php echo $inventory->remark; ?>">
						
					</div>
					<div class="form-group">
                        <label for="exampleInputEmail1">Part number</label>
                        <input name="part_number"  class="form-control" id="part_number" placeholder="Enter part number" value="<?php echo $inventory->part_number; ?>" >
                    </div>
					 ...
					 <div class="form-group">
                        ...
                        <input name="register_time"  class="form-control" id="regiister_time"  value="<?php echo $inventory->register_time; ?>" required>
                    </div>
		
					<div class="form-group">
                        <label for="exampleInputEmail1">Registered user</label>
                        <select name= "register_userid" id="register_userid" class="form-control" data-rel="chosen">
                           <?php foreach($users as $item) { ?>
							<option value=<?php echo $item->user_id; ?>  <?php if($item->user_id == $inventory->register_userid) { echo " selected";} ?> ><?php echo $item->user_name; ?></option>
						   <?php } ?>
                        </select>
					 ...
					 <div class="form-group">
                        <label for="exampleInputPassword1">Removed time</label>
                        <input name="remove_time"  class="form-control" id="remove_time"  value="<?php echo $inventory->remove_time; ?>" >
                    </div>
		
					<div class="form-group">
                        <label for="exampleInputEmail1">Remove user</label>
                        <select name= "remove_userid" id="remove_userid" class="form-control" data-rel="chosen">
							<option value=0 <?php if ($inventory->remove_userid == 0) echo "selected";  ?>>  </option>
                           <?php foreach($users as $item) { ?>
							<option value=<?php echo $item->user_id; ?> <?php if($item->user_id == $inventory->remove_userid) { echo " selected";} ?>><?php echo $item->user_name; ?></option>
						   <?php } ?>
					...
					<div class="control-group">
						<label class="control-label" for="selectError">Select Quantity</label>

						<div class="controls">
							<select name="edit_quantity" id="selectError" data-rel="chosen">
								<?php for ($i=0; $i < $inventory->quantity; $i++) { ?>
